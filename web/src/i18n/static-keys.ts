...
export const STATIC_I18N_KEYS = [
  ...
  // Violation detection
  'All Detection Statuses',
  'Allowed',
  'Blocked',
  'Bypassed',
  'Channel detection stats',
  'Checked by the detector and passed',
  'Detection',
  'Detection passed',
  'Detector failures that were forwarded',
  'Failed open',
  'Flagged',
  'Forwarded and flagged requests grouped by channel.',
  'Forwarded and flagged requests grouped by user group.',
  'Group detection stats',
  'Historical unmarked',
  'Illegal requests',
  'Most frequent detector labels among flagged requests.',
  'No channel statistics yet.',
  'No flagged objects yet.',
  'No group statistics yet.',
  'Normal requests',
  'Object',
  'Passed',
  'Requests flagged after response',
  'Requests forwarded upstream',
  'Save violation detection',
  'Top flagged objects',
  'Unmarked',
